...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_CREATECHILD) {
            ChildItem newChild = new ChildItem(data.getExtras().getString("name"),data.getExtras().getString("tag"), "time", R.drawable.child);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(getApplicationContext(), item.getName() + "의 위치", Toast.LENGTH_LONG).show();
            }
        });
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intentCreateChild = new Intent(getApplicationContext(), CreateChildActivity.class);
